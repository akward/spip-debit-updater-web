...
const ENV_ROWS = [
  ...
  [
    "SHEET_ACQUIRER_TRX",
    "Acquirer transaksi Vol/Nom (On Us, Off Us, Internasional) — notebook: 1dyII_IIERsu6hol9A_H_PxObR-IxWMJ5SslCCL3i4YM",
  ],
  [
    "SHEET_ACQUIRER_EDC",
    "Acquirer EDC matrix (EDC Debet/Kredit/Uang Elektronik/Gabungan) — notebook: 1Tl5nb_rjiwFA0xa6j15iqIyYGTq2Kf6P6B35vmHbi-8",
  ],
