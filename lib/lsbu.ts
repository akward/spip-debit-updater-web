...
export const KK_LSBU_MAP: {
  ...
  { match: "Nilai Outstanding", cols: KK_OUTSTANDING_COLS, divideBy: 1_000_000, label: "SUM outstanding" },
  { match: "Nilai NPL", cols: KK_NPL_COLS, divideBy: 1_000_000, label: "SUM NPL 90-180 DPD" },
  { match: "Volume Tunai", cols: ["VOLUME_TUNAI_DOMESTIK", "VOLUME_TUNAI_INTERNASIONAL"], divideBy: 1, label: "VOLUME_TUNAI dom+intl" },
  { match: "Nilai Tunai", cols: ["NILAI_TUNAI_DOMESTIK", "NILAI_TUNAI_INTERNASIONAL"], divideBy: 1_000_000, label: "NILAI_TUNAI dom+intl" },
  { match: "Volume Belanja", cols: ["VOLUME_BELANJA_DOMESTIK", "VOLUME_BELANJA_INTERNASIONAL"], divideBy: 1, label: "VOLUME_BELANJA dom+intl" },
  { match: "Nilai Belanja", cols: ["NILAI_BELANJA_DOMESTIK", "NILAI_BELANJA_INTERNASIONAL"], divideBy: 1_000_000, label: "NILAI_BELANJA dom+intl" },
];
