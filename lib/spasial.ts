/**
 * Spasial updater — notebook parity (Spasial_google sheet.ipynb)
 * sheet = bulan, rows = wilayah (kode 4 digit), columns = metrik
...
export const SPASIAL_ATM_TASKS: SpasialTask[] = [
  ...
  { label: "Vol Pembayaran", fileHints: ["transaksi_pembayaran_atm"], spKey: "lokasitransaksi", mode: "vol", lsbuCodes: ["091-Volume transaksi pembayaran internasional", "092-Volume transaksi pembayaran domestik"], lsbuCols: ["KARTU_ATM", "KARTU_ATM_DEBIT"] },
  { label: "Vol Interbank", fileHints: ["transfer_interbank_atm", "interbank"], spKey: "lokasitransaksi", mode: "vol", lsbuCodes: ["084-Volume transaksi transfer dana antar bank internasional", "085-Volume transaksi transfer dana antar bank domestik"], lsbuCols: ["KARTU_ATM", "KARTU_ATM_DEBIT"] },
  { label: "Vol Antarbank", fileHints: ["transfer_antarbank_atm", "antarbank"], spKey: "lokasitransaksi", mode: "vol", lsbuCodes: ["083-Volume transaksi transfer dana intra bank"], lsbuCols: ["KARTU_ATM", "KARTU_ATM_DEBIT"] },
  { label: "Nom Tunai", fileHints: ["transaksi_tunai_atm"], spKey: "lokasitransaksi", mode: "nom" },
  { label: "Nom Setor Tunai", fileHints: ["transaksi_setor_tunai_atm", "setor_tunai"], spKey: "lokasitransaksi", mode: "nom" },
  { label: "Nom Belanja", fileHints: ["transaksi_belanja_atm"], spKey: "lokasitransaksi", mode: "nom" },
  { label: "Nom Pembayaran", fileHints: ["transaksi_pembayaran_atm"], spKey: "lokasitransaksi", mode: "nom" },
  { label: "Nom Interbank", fileHints: ["transfer_interbank_atm", "interbank"], spKey: "lokasitransaksi", mode: "nom" },
  { label: "Nom Antarbank", fileHints: ["transfer_antarbank_atm", "antarbank"], spKey: "lokasitransaksi", mode: "nom" },
];

export const SPASIAL_UE_TASKS: SpasialTask[] = [
  { label: "Jumlah UE", fileHints: ["jumlah_ue_beredar"], spKey: "kota", mode: "instrumen", lsbuCodes: ["001-Jumlah Kartu"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "registered", fileHints: ["jumlah_ue_registered"], spKey: "kota", mode: "instrumen", lsbuCodes: ["056-Registered"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "unregistered", fileHints: ["unregistered"], spKey: "kota", mode: "instrumen", lsbuCodes: ["057-Unregistered"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "chipbased", fileHints: ["jumlah_ue_chip", "chip"], spKey: "kota", mode: "instrumen", lsbuCodes: ["051-Chip based"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "serverbased", fileHints: ["jumlah_ue_server", "server"], spKey: "kota", mode: "instrumen", lsbuCodes: ["052-Server based"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "Dana Float", fileHints: ["jumlah_ue_server", "server"], spKey: "kota", mode: "instrumen", lsbuCodes: ["070-Dana Float"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "Mesin Reader", fileHints: ["reader_ue"], spKey: "kota", mode: "instrumen", lsbuCodes: ["122-Jumlah Mesin Reader Uang Elektronik"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  ...
  { label: "Nom Tarik Tunai", fileHints: ["transaksi_tunai_ue"], spKey: "lokasitransaksi", mode: "nom_juta", lsbuCodes: ["118-Nominal transaksi tarik tunai uang elektronik"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  ...
  { label: "Nom Belanja", fileHints: ["transaksi_belanja_uang_elektronik", "belanja_uang"], spKey: "lokasitransaksi", mode: "nom_juta", lsbuCodes: ["106-Nominal transaksi belanja internasional", "107-Nominal transaksi belanja domestik"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  ...
  { label: "Nom Pembayaran", fileHints: ["transaksi_pembayaran_uang_elektronik", "pembayaran_uang"], spKey: "lokasitransaksi", mode: "nom_juta", lsbuCodes: ["108-Nominal Transaksi Online Internasional", "109-Nominal Transaksi Online Domestik"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "Vol Initial", fileHints: ["transaksi_initial"], spKey: "lokasitransaksi", mode: "vol", lsbuCodes: ["096-Volume transaksi Initial"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "Nom Initial", fileHints: ["transaksi_initial"], spKey: "lokasitransaksi", mode: "nom_juta", lsbuCodes: ["116-Nominal transaksi Initial"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "Vol Reload", fileHints: ["transaksi_top_up", "top_up", "topup"], spKey: "lokasitransaksi", mode: "vol", lsbuCodes: ["097-Volume transaksi reload/top up"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "Nom Reload", fileHints: ["transaksi_top_up", "top_up", "topup"], spKey: "lokasitransaksi", mode: "nom_juta", lsbuCodes: ["117-Nominal transaksi reload/top up"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  ...
  { label: "Nom Transfer Antar UE", fileHints: ["transfer_antar_uang_elektronik", "antar_uang"], spKey: "lokasitransaksi", mode: "nom_juta", lsbuCodes: ["113-Nominal transaksi transfer antar uang elektronik"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "Vol Redeem", fileHints: ["transaksi_redeem", "redeem"], spKey: "lokasitransaksi", mode: "vol", lsbuCodes: ["099-Volume transaksi reedem"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "Nom Redeem", fileHints: ["transaksi_redeem", "redeem"], spKey: "lokasitransaksi", mode: "nom_juta", lsbuCodes: ["119-Nominal transaksi reedem"], lsbuCols: ["KARTU_ELEKTRONIK"] },
  { label: "Vol Transfer ke Rekening", fileHints: ["transfer_ue_ke_rekening", "ke_rekening"], spKey: "lokasitransaksi", mode: "vol" },
  { label: "Nom Transfer ke Rekening", fileHints: ["transfer_ue_ke_rekening", "ke_rekening"], spKey: "lokasitransaksi", mode: "nom_juta" },
  { label: "Vol Transfer Pemerintah", fileHints: ["transfer_pemerintah"], spKey: "lokasitransaksi", mode: "vol" },
  { label: "Nom Transfer Pemerintah", fileHints: ["transfer_pemerintah"], spKey: "lokasitransaksi", mode: "nom_juta" },
];

export const SPASIAL_KK_TASKS: SpasialTask[] = [
  { label: "Kartu Kredit", fileHints: ["jumlah_kk_beredar", "kk_beredar"], spKey: "kotakab", mode: "kk_total" },
  { label: "Outstanding", fileHints: ["nominal_outstanding", "outstanding"], spKey: "kotakab", mode: "nom_juta" },
  { label: "NPL", fileHints: ["nominal_npl", "npl"], spKey: "kotakab", mode: "nom_juta" },
  { label: "Vol Tunai", fileHints: ["transaksi_tunai_kk"], spKey: "lokasitransaksi", mode: "vol" },
  { label: "Nom Tunai", fileHints: ["transaksi_tunai_kk"], spKey: "lokasitransaksi", mode: "nom_juta" },
  { label: "Vol Belanja", fileHints: ["transaksi_belanja_kk"], spKey: "lokasitransaksi", mode: "vol" },
  { label: "Nom Belanja", fileHints: ["transaksi_belanja_kk"], spKey: "lokasitransaksi", mode: "nom_juta" },
  { label: "Vol Bill Payment", fileHints: ["bill_payment_kk", "bill_payment"], spKey: "lokasitransaksi", mode: "vol" },
  { label: "Nom Bill Payment", fileHints: ["bill_payment_kk", "bill_payment"], spKey: "lokasitransaksi", mode: "nom_juta" },
];
...
function cleanKey(val: unknown): string {
  ...
  if (!s || s === "n/a" || s === "nan" || s === "0") return "n/a";
...
function pickKeyCol(row: Record<string, unknown>, spKey: string): unknown {
  const want = spKey.toLowerCase();
  for (const k of Object.keys(row)) {
    if (k.toLowerCase() === want) return row[k];
  }
  for (const k of Object.keys(row)) {
    if (k.toLowerCase().replace(/[\s_]/g, "") === want.replace(/[\s_]/g, ""))
      return row[k];
  }
  return undefined;
}
...
function aggregateSpatial(
  ...
  for (const r of rows) {
    ...
    if (key === "n/a") continue;
    let v = 0;
    if (task.mode === "kartu" || task.mode === "instrumen" || task.mode === "kk_total") {
      const e1 = num(r["expr_1"] ?? r["EXPR_1"]);
      const e2 = num(r["expr_2"] ?? r["EXPR_2"]);
...
function aggregateLsbu(lsbuRows: Row[], task: SpasialTask): Map<string, number> {
  ...
  const codes = new Set(task.lsbuCodes.map((c) => c.trim().toLowerCase()));
  const cols = task.lsbuCols?.length
    ? task.lsbuCols
    : ["KARTU_ATM", "KARTU_ATM_DEBIT", "KARTU_ELEKTRONIK"];

  for (const r of lsbuRows) {
    const jd = String(r["JENIS_DATA"] ?? r["jenis_data"] ?? "").trim();
    if (!codes.has(jd.toLowerCase())) continue;
        ...
        results: [
          {
            job: "(setup)",
            status: "info",
            reason: `Dry-run: sheet '${sheetName}' belum ada / belum bisa dibaca. Akan di-copy dari template saat write.`,
          },
          ...tasks.map((t) => {
    ...
    try {
      ...
      if (!opts.dryRun) {
        ...
        for (let r = 1; r < grid.length; r++) {
          const k = keyByRow[r];
          if (!k || k === "n/a") continue;
          let val = finals.get(k) ?? 0;
          const cell =
            task.mode === "nom" || task.mode === "nom_juta"
